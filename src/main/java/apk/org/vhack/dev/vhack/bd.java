...
class bd extends AsyncTask {
    ...
    protected String a(String... strArr) {
        try {
            try {
                HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(fc.a(this.a.getApplicationContext(), "cname", strArr[0], "vh_clusterJoin.php")).openConnection();
                try {
    ...
    protected void a(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case l.AppCompatTheme_buttonBarButtonStyle /*51*/:
                ...
                break;
            case l.AppCompatTheme_colorButtonNormal /*88*/:
                if (str.equals("X")) {
                    i = 2;
                    break;
                }
        ...
        switch (i) {
            case R.styleable.WalletFragmentStyle_buyButtonHeight /*0*/:
                ...
                Toast.makeText(this.a.getApplicationContext(), 2131165303, 1).show();
            ...
            case R.styleable.WalletFragmentStyle_maskedWalletDetailsTextAppearance /*4*/:
                Toast.makeText(this.a.getApplicationContext(), 2131165289, 1).show();
