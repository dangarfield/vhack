...
class p extends AsyncTask {
    ...
    p(BonusBoxActivity bonusBoxActivity) {
    ...
    protected String a(String... strArr) {
        try {
            try {
                HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(fc.a(this.a.getApplicationContext(), "", "", "vh_openPremBonus.php")).openConnection();
                try {
    ...
    protected void a(String str) {
            ...
            try {
                ...
                switch (i) {
                    case R.styleable.WalletFragmentStyle_buyButtonHeight /*0*/:
                        ...
                        Integer.parseInt(this.a.n.getString("netcoins", "0"));
                        int parseInt = Integer.parseInt(jSONObject.getString("win"));
                        Integer.parseInt(this.a.n.getString("bonus", "0"));
                        textView3.setText(this.a.a(jSONObject.getString("bleft")));
                    ...
                    case ModuleDescriptor.MODULE_VERSION /*1*/:
                        ...
                        Long valueOf = Long.valueOf(Long.parseLong(this.a.n.getString("money", "0")));
                        Long valueOf2 = Long.valueOf(Long.parseLong(jSONObject.getString("win")));
                        Integer.parseInt(this.a.n.getString("bonus", "0"));
                        textView3.setText(this.a.a((valueOf.longValue() + valueOf2.longValue()) + ""));
                        textView2.setText("+" + this.a.a(valueOf2 + ""));
                        ((TextView) this.a.findViewById(2131558562)).setText(this.a.a(jSONObject.getString("bleft")));
                        edit = this.a.n.edit();
                        edit.putString("money", (valueOf.longValue() + valueOf2.longValue()) + "");
                        edit.putString("netcoins", jSONObject.getString("bleft"));
                        edit.commit();
                        break;
                    case R.styleable.WalletFragmentStyle_buyButtonText /*2*/:
                        ...
                        edit2.putString("netcoins", jSONObject.getString("bleft"));
                        edit2.commit();
                        if (jSONObject.getString("win").equals("1")) {
                            ...
                            edit2.putString("fw", (Integer.parseInt(this.a.n.getString("fw", "0")) + i) + "");
                            edit2.commit();
                        }
                        if (jSONObject.getString("win").equals("2")) {
                            ...
                            edit2.putString("av", (Integer.parseInt(this.a.n.getString("av", "0")) + i) + "");
                            edit2.commit();
                        }
                        if (jSONObject.getString("win").equals("3")) {
                            ...
                            edit2.putString("sdk", (Integer.parseInt(this.a.n.getString("sdk", "0")) + i) + "");
                            edit2.commit();
                        }
                        if (jSONObject.getString("win").equals("4")) {
                            ...
                            edit2.putString("ipsp", (Integer.parseInt(this.a.n.getString("ipsp", "0")) + i) + "");
                            edit2.commit();
                        }
                        if (jSONObject.getString("win").equals("5")) {
                            ...
                            edit2.putString("spam", (Integer.parseInt(this.a.n.getString("spam", "0")) + i) + "");
                            edit2.commit();
                        }
                        if (jSONObject.getString("win").equals("6")) {
                            ...
                            edit2.putString("scan", (Integer.parseInt(this.a.n.getString("scan", "0")) + i) + "");
                            edit2.commit();
                        }
                        if (jSONObject.getString("win").equals("7")) {
                            ...
                            edit2.putString("adw", (Integer.parseInt(this.a.n.getString("adw", "0")) + i) + "");
                            edit2.commit();
                            break;
                        }
                        break;
        ...
        Toast.makeText(this.a.getApplicationContext(), "You dont have enough NetCoins.", 0).show();
    }
}
