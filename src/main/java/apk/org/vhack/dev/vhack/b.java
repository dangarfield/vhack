...
class b extends AsyncTask {
    ...
    b(AdWareActivity adWareActivity) {
    ...
    protected String a(String... strArr) {
        try {
            try {
                HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(fc.a(this.a.getApplicationContext(), "", "", "vh_adwareInfo.php")).openConnection();
                try {
        ...
        if (str.length() > 5) {
            try {
                ...
                if (valueOf2.intValue() > 0) {
                    ...
                    this.a.t.setOnItemClickListener(new c(this));
                }
