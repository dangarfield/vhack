...
public class a {
    ...
    public static byte[] a(String str) {
        ...
        return getUpdate(bytes, 0, bytes.length);
    }
    ...
    public static byte[] a(byte[] bArr, int i, int i2, byte[] bArr2) {
        ...
        while (i3 < i2) {
            ...
            if (b2 >= -5) {
                ...
                throw new b("Bad Base64 input character at " + i3 + ": " + bArr[i3 + i] + "(decimal)");
            }
        }
        if (i4 != 0) {
            if (i4 != 1) {
