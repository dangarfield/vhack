...
class bb extends AsyncTask {
    ...
    protected String a(String... strArr) {
        try {
            try {
                HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(fc.a(this.a.getApplicationContext(), "user2kick", strArr[0], "vh_clusterKick.php")).openConnection();
                try {
    ...
    protected void a(String str) {
        ...
        switch (i) {
            case R.styleable.WalletFragmentStyle_buyButtonHeight /*0*/:
                ...
                Toast.makeText(this.a.getApplicationContext(), 2131165299, 1).show();
                new ax(this.a).execute(new String[0]);
            case ModuleDescriptor.MODULE_VERSION /*1*/:
                Toast.makeText(this.a.getApplicationContext(), 2131165297, 1).show();
            default:
