...
public class PathParser {
    ...
    private PathParser(char c, float[] fArr) {
        this.f19a = c;
        this.f20b = fArr;
    }

    private PathParser(PathParser pathParser) {
        this.f19a = pathParser.f19a;
        this.f20b = PathParser.m14b(pathParser.f20b, 0, pathParser.f20b.length);
    }

    public static void m18a(PathParser[] pathParserArr, Path path) {
        float[] fArr = new float[6];
        char c = 'm';
        for (int i = 0; i < pathParserArr.length; i++) {
            PathParser.m17a(path, fArr, c, pathParserArr[i].f19a, pathParserArr[i].f20b);
            c = pathParserArr[i].f19a;
        }
    }
    ...
    private static void m17a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
        ...
        switch (c2) {
            ...
            case R.AppCompatTheme_buttonBarNegativeButtonStyle /*97*/:
                i = 7;
                break;
            case R.AppCompatTheme_textColorSearchUrl /*67*/:
            case R.AppCompatTheme_autoCompleteTextViewStyle /*99*/:
                i = 6;
                break;
            case R.AppCompatTheme_listPreferredItemPaddingLeft /*72*/:
            case R.AppCompatTheme_colorControlActivated /*86*/:
            case R.AppCompatTheme_editTextStyle /*104*/:
            case 'v':
                i = 1;
                break;
            case R.AppCompatTheme_textAppearanceListItem /*76*/:
            case R.AppCompatTheme_textAppearanceListItemSmall /*77*/:
            case R.AppCompatTheme_colorAccent /*84*/:
            case R.AppCompatTheme_ratingBarStyleSmall /*108*/:
            case R.AppCompatTheme_seekBarStyle /*109*/:
            case 't':
                i = 2;
                break;
            case R.AppCompatTheme_listChoiceBackgroundIndicator /*81*/:
            case R.AppCompatTheme_colorPrimaryDark /*83*/:
            case 'q':
            case 's':
                i = 4;
                break;
        ...
        while (i2 < fArr2.length) {
            ...
            switch (c2) {
                case R.AppCompatTheme_textAppearanceSearchResultTitle /*65*/:
                    ...
                    PathParser.m16a(path, f10, f9, f5, f2, f, f11, f12, z, z2);
                    f3 = fArr2[i2 + 5];
                    f4 = fArr2[i2 + 6];
                    f6 = f7;
                    f5 = f8;
    ...
    private static void m16a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        ...
        if (d10 < 0.0d) {
            ...
            PathParser.m16a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
            return;
        }
        d9 = Math.sqrt(d10);
        d5 *= d9;
        ...
        d = ((double) f5) * d6;
        d5 *= (double) f6;
        PathParser.m15a(path, (d * cos) - (d5 * sin), (d * sin) + (d5 * cos), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d4);
    }
